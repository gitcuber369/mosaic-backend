...
export async function createStory(req: Request, res: Response) {
  ...
  try {
    ...
    try {
      ...
      const userPrompt = `Write a children's bedtime story about following user provided character / situation: ${character} who enjoys ${hobbies.join(
        ", "
      ...
      // JSON instruction with introduction title field
      ...
      if (
        ...
        // Handle new response format with AI-generated introduction title
